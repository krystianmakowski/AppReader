...
//    private val lisOfBooks: MutableState<DataOrException<List<Item>,Boolean,Exception>>
...
//                return@launch
//            }
//            lisOfBooks.value.loading = true
//            lisOfBooks.value = repository.getBooks(query)
//            Log.d("DATA", "searchBooks: ${lisOfBooks.value.data.toString()}")
//            if (lisOfBooks.value.data.toString().isNotEmpty()) lisOfBooks.value.loading = false
//        }
//    }
//}