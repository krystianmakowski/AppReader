package com.makowski.appreader.screens.stats
...
import com.makowski.appreader.screens.search.BookRow
            ...
            Column {
                ...
                Card(modifier = Modifier
                    ...
                    Column(modifier = Modifier.padding(start = 25.dp, top = 4.dp, bottom = 4.dp), horizontalAlignment = Alignment.Start) {
                        ...
                        Divider()
                        Text(text = "Yo're reading: ${readingBooks.size} books")
                        Text(text = "Yo're read: ${readBookList.size} books")
                    }
                }
