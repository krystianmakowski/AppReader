...
import com.makowski.appreader.components.FABContent
import com.makowski.appreader.components.ReaderAppBar
import com.makowski.appreader.components.RoundedButton
...
@Composable
fun DetailsScreen(navController: NavController, bookId: String, viewModel: DetailsViewModel = hiltViewModel()){
    Scaffold(topBar = {
        ...
        Surface(modifier = Modifier
            ...
            Column(modifier = Modifier.padding(top = 12.dp), verticalArrangement = Arrangement.Top, horizontalAlignment = Alignment.CenterHorizontally) {
                ...
                if (bookInfo.data == null){
                    ...
                    ShowDetailsBook(bookInfo, navController)
                }
            }
...
@Composable
fun ShowDetailsBook(bookInfo: Resource<Item>, navController: NavController) {
    ...
    Text(text = bookData?.title.toString(), style = MaterialTheme.typography.h6, overflow = TextOverflow.Ellipsis, maxLines = 5)
