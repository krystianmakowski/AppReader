package com.makowski.appreader.screens.update
...
import com.makowski.appreader.data.DataOrException
...
import com.makowski.appreader.utils.formatDate

@Composable
fun UpdateScreen(navController: NavController, bookItemId: String, viewModel: HomeScreenViewModel = hiltViewModel()) {
    Scaffold(topBar = {
        ReaderAppBar(
            title = "Update Book",
        ...
        Surface(
            ...
            Column(
                ...
                if (bookInfo.loading == true) {
                    ...
                    ShowForm(book = viewModel.data.value.data?.first { mBook ->
...
@Composable
fun ShowForm(book: MBook, navController: NavController) {
        ...
        RoundedButton(label = "Update") {
            if (bookUpdate){
                FirebaseFirestore.getInstance()
                    ...
                    .addOnFailureListener { Log.d("Error", "Error updating document", it) }
            }
